...
const index = () => {
  return (
    <div className="px-5">
      ...
      <div className="bg-gray-400 my-3 grid sm:grid-cols-1 lg:grid-cols-2 gap-4 p-5 dark:bg-dark-200 dark:bg-black-500" style={{ marginLeft: '-1.3rem', marginRight: '-1.3rem' }}>
        {
