...
const Sidebar = () => {
    return (
        <div>
            ...
            <div className="bio-details pt-5 lg:pt-9">
            ...
            <div className='address py-5 lg:py-6 bg-gray-200' style={{ marginLeft: '-1rem', marginRight: "-1rem" }}>
                <div className="location flex items-center justify-center space-x-2">
                    <FaLocationArrow className="w-5 h-5" />
                    <h6 className=""> Kolkata, India</h6>
                </div>
            ...
            <div className="contact pt-3">
                ...
                <button className="bg-gradient-to-r from-green-500 to-blue-500 w-9/12 py-4 rounded-full my-2">Dark UI</button>
            </div>
        </div>
    )
}
